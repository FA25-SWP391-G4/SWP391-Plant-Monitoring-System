          ...
          <div className="mb-8 inline-flex items-center justify-center">
            <span className="flex h-24 w-24 items-center justify-center rounded-full bg-emerald-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-600">
                ...
                <path d="M6.04 4.13A9.97 9.97 0 0 1 12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12a9.96 9.96 0 0 1 2.3-6.42"></path>
                <path d="M12 14h.01"></path>
              </svg>
            </span>
          </div>
          <h1 className="text-5xl font-bold text-gray-900 mb-6">{t('notFound.title', 'Oops! Page Not Found')}</h1>
          <p className="text-xl text-gray-600 max-w-lg mx-auto mb-10">
            {t('notFound.message', "The page you're looking for doesn't seem to exist or has been moved. Let's get you back on track.")}
          </p>
