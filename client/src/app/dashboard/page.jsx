        ...
        {settings.widgets?.showPlantOverview && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 stagger-item">
            <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center stagger-item">
              ...
              <div>
                <p className={`text-gray-500 dark:text-gray-400 text-sm ${showTitles ? '' : 'hidden'}`}>Total Trees</p>
            ...
            <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center stagger-item">
              ...
              <div>
                <p className={`text-gray-500 dark:text-gray-400 text-sm ${showTitles ? '' : 'hidden'}`}>Healthy</p>
            ...
            <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center stagger-item">
              ...
              <div>
                <p className={`text-gray-500 dark:text-gray-400 text-sm ${showTitles ? '' : 'hidden'}`}>Needs Attention</p>
