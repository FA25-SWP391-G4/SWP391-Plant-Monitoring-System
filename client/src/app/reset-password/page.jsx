        ...
        <section className="container mx-auto px-6 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div style={{ opacity: 1, transform: 'none' }}>
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-4">
              <span>{t('auth.resetPasswordHeader', 'Reset Your Password')}</span><br />
              <span className="text-emerald-600">{t('auth.secureAccess', 'Secure Access Restored')}</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-xl leading-relaxed">
              <span>{t('auth.resetPasswordMessage', 'Choose a strong new password to protect your account.')}</span>
            </p>
          </div>
