        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-3">{t('features.smartWatering', 'Smart Watering')}</h3>
              <p className="text-gray-600">
                {t('features.smartWateringDesc', 'Automated watering system that delivers the perfect amount of water based on soil moisture, plant type, and environmental conditions.')}
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-3">{t('features.lightOptimization', 'Light Optimization')}</h3>
              <p className="text-gray-600">
                {t('features.lightOptimizationDesc', 'Advanced light sensors monitor and optimize lighting conditions, ensuring your plants receive the ideal spectrum and intensity.')}
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-3">{t('features.healthAlerts', 'Health Alerts')}</h3>
              <p className="text-gray-600">
                {t('features.healthAlertsDesc', 'Instant notifications about plant health issues, diseases, or care requirements sent directly to your smartphone.')}
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-600 mb-6">
                {t('testimonials.sarahText', '"PlantSmart completely transformed my plant care routine. I used to kill every plant I touched, but now my apartment is a thriving jungle! The AI recommendations are incredibly accurate."')}
              </p>
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-semibold">{t('testimonials.sarahName', 'Sarah Chen')}</h4>
                  <p className="text-sm text-gray-500">{t('testimonials.sarahLocation', 'San Francisco, CA')}</p>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-100 flex items-center">
                <span className="bg-green-100 text-green-600 text-xs py-1 px-2 rounded-full flex items-center">
                  ...
                  {t('testimonials.plantsCount', '12 plants thriving')}
                </span>
                <span className="ml-auto text-xs text-gray-400">Verified Review</span>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
              ...
              <div className="flex text-amber-400 mb-3">★★★★★</div>
              <p className="text-gray-600 mb-6">
                {t('testimonials.marcusText', '"As a busy entrepreneur, I never had time for proper plant care. The automated watering system is a game-changer. My plants have never looked better, and I get peace of mind."')}
              </p>
              <div className="flex items-center">
                <div className="h-12 w-12 bg-green-100 rounded-full flex items-center justify-center mr-4">
                  <span className="text-xl">👨</span>
                ...
                <div>
                  <h4 className="font-semibold">{t('testimonials.marcusName', 'Marcus Rodriguez')}</h4>
                  <p className="text-sm text-gray-500">{t('testimonials.marcusLocation', 'Austin, TX')}</p>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-100 flex items-center">
                <span className="bg-green-100 text-green-600 text-xs py-1 px-2 rounded-full flex items-center">
                  ...
                  {t('testimonials.marcusPlantsCount', '8 plants saved')}
                </span>
                <span className="ml-auto text-xs text-gray-400">Verified Review</span>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
              ...
              <div className="flex text-amber-400 mb-3">★★★★★</div>
              <p className="text-gray-600 mb-6">
                {t('testimonials.emilyText', '"The health alerts saved my fiddle leaf fig from a pest infestation I never would have caught early. The mobile app makes monitoring so convenient and actually fun!"')}
              </p>
              <div className="flex items-center">
                <div className="h-12 w-12 bg-green-100 rounded-full flex items-center justify-center mr-4">
                  <span className="text-xl">👩</span>
                ...
                <div>
                  <h4 className="font-semibold">{t('testimonials.emilyName', 'Emily Watson')}</h4>
                  <p className="text-sm text-gray-500">{t('testimonials.emilyLocation', 'Portland, OR')}</p>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-100 flex items-center">
                <span className="bg-green-100 text-green-600 text-xs py-1 px-2 rounded-full flex items-center">
                  ...
                  {t('testimonials.emilyPlantsCount', '15 plants monitored')}
                </span>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-3">{t('features.mobileDashboard', 'Mobile Dashboard')}</h3>
              <p className="text-gray-600">
                {t('features.mobileDashboardDesc', 'Complete plant management from your phone with real-time monitoring, care schedules, and growth tracking.')}
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-3">{t('features.aiPlantDoctor', 'AI Plant Doctor')}</h3>
              <p className="text-gray-600">
                {t('features.aiPlantDoctorDesc', 'Machine learning algorithms analyze your plant data to provide personalized care recommendations and predict potential issues.')}
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-3">{t('features.iotSensors', 'IoT Sensors')}</h3>
              <p className="text-gray-600">
                {t('features.iotSensorsDesc', 'Network of wireless sensors monitoring temperature, humidity, soil pH, and nutrients for comprehensive plant care.')}
              </p>
