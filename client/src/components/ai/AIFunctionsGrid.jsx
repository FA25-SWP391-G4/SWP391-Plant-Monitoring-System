...
const AIFunctionsGrid = ({ isPremium = false }) => {
  ...
  const aiFunctions = [
    ...
    },
    {
      ...
      title: t('ai.functions.imageRecognition', 'Image Recognition'),
      description: t('ai.functions.imageRecognitionDesc', 'Upload plant photos for instant health assessment'),
    ...
    },
    {
      ...
      title: t('ai.functions.diseaseDetection', 'Disease Detection'),
      description: t('ai.functions.diseaseDetectionDesc', 'Identify plant diseases and get treatment suggestions'),
    ...
    {
      id: 'watering-predictions',
      title: t('ai.functions.wateringPredictions', 'Watering Predictions'),
      description: t('ai.functions.wateringPredictionsDesc', 'AI-powered watering schedules based on your plants'),
    ...
    {
      id: 'growth-tracking',
      title: t('ai.functions.growthTracking', 'Growth Tracking'),
      description: t('ai.functions.growthTrackingDesc', 'Monitor and predict plant growth patterns'),
      icon: <TrendingUp className="h-8 w-8" />,
      color: 'from-purple-500 to-violet-600',
      href: '/ai/growth-tracking',
      category: 'predictions',
      premium: true
    },
    {
