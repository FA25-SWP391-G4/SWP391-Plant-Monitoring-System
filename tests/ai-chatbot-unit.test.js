...
const chatbotController = require('../ai-service/controllers/chatbotController');
const openRouterService = require('../ai-service/services/openRouterService');
const sensorService = require('../ai-service/services/sensorService');
const ChatbotLog = require('../ai-service/models/ChatbotLog');

// Mock dependencies
jest.mock('../ai-service/services/openRouterService');
jest.mock('../ai-service/services/sensorService');
jest.mock('../ai-service/models/ChatbotLog');
jest.mock('../ai-service/mqtt/aiMqttClient', () => ({
...
describe('Chatbot Controller Unit Tests', () => {
  ...
  describe('MQTT Integration and Real-time Responses', () => {
    ...
    beforeEach(() => {
      mockMqttClient = require('../ai-service/mqtt/aiMqttClient');
    });
