      ...
      <header className="w-full px-6 py-4 bg-white/80 backdrop-blur-sm border-b border-green-100">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="#benefits" className="text-gray-600 hover:text-green-600 transition-colors">
              Benefits
            </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/logout">
              <Button
                variant="outline"
                className="border-gray-200 hover:border-red-200 hover:text-red-600 bg-transparent"
              >
                Sign Out
              </Button>
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Never Kill
                <br />
                <span className="text-green-600">Another Plant</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-gray-200 hover:border-green-200 px-8 py-4 text-lg font-semibold rounded-xl bg-transparent"
              >
          ...
          <div className="relative">
                ...
                <div className="bg-gradient-to-r from-green-500 to-green-600 p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-green-100 text-sm">Real-time care tracking</p>
                    </div>
                  </div>
                </div>
                ...
                <CardContent className="p-6">
                  <div className="space-y-6">
                    ...
                    <div className="bg-green-50 rounded-xl p-4">
                      ...
                      <p className="text-sm text-green-600">Your plant is thriving! Next watering in 3 days.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="absolute -top-4 -right-4 w-72 h-72 bg-green-200/30 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-8 -left-8 w-64 h-64 bg-green-300/20 rounded-full blur-3xl"></div>
          </div>
        </div>
      </main>
    </div>
